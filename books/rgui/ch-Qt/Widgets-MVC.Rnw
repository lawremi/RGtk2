...
\begin{figure}
  ...
  \end{minipage}
  \caption{The \code{tree\_model} instance viewed in a tree view, a table view and a list view}
...
%
Figure~\ref{fig:qt-treemodel-views} shows the \code{tree\_model} in
