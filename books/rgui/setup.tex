...
\usepackage{listings}
\usepackage{booktabs}
\usepackage{multind}            % for concept index
\makeindex{general}             % for classes, methods, functions
\makeindex{concepts}            % for higher level concepts

\usepackage[twoside,citeonce(part)]{footbib} % for citations as
                                % footnotes use \footcite
...
\newcommand{\defn}[1]{\textit{#1}\index{general}{#1|textbf}}   % add in index
...
\newcommand{\constructor}[1]{\function{#1}\index{general}{#1}}

\newcommand{\args}[1]{\code{#1}} % name of argument only
\newcommand{\argument}[2]{\args{#1}\index{general}{#2!\texttt{#1}}} % name of
                                % an argument, plus
\newcommand{\subcommand}[2]{\textit{#2} \args{#1}\index{general}{#2!\code{#1}}} % name of an tk subcommand plus
                                % function for index
\newcommand{\subcommanda}[3]{\subcommand{#1}{#2} \textit{#3} }
\newcommand{\option}[2]{\args{#1}\index{general}{#2!\code{#1}}} % name of an option plus constructor
...
\newcommand{\meth}[1]{\code{#1}}     % single arg, no class
\newcommand{\method}[2]{\meth{#1}\index{general}{#2!\texttt{#1}}} % name of method with
                                % class for index
\newcommand{\prop}[1]{\generic{#1}}     % single arg, no class
\newcommand{\property}[2]{\prop{#1}\index{general}{#2!\code{#1}}} % name of
                               % widget property
\newcommand{\qtproperty}[1]{\prop{#1}} % qt property
\newcommand{\qtenumeration}[1]{\generic{#1}\index{general}{Qt enumerations!\texttt{#1}}} % an enumerated flag in
\newcommand{\enumeration}[1]{\qtenumeration{#1}}
%% Gtk enumeration
\newcommand{\gtkenum}[1]{\generic{#1}\index{general}{GTK enumerations!\texttt{#1}}}
                                % Qt$Qt object
...
\newcommand{\pkg}[1]{\texttt{#1}\index{general}{R Package!\code{#1}}}
...
%%% Uncomment for statement about draft on bottom
