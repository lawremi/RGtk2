...
model. 
% This thought leads itself to the prevalent
% model-view-controller architecture of many large GUI applications. 
% For many of our examples in the text, we avoid that level of design, but
% do try to keep separate the different aspects of GUI design. 
