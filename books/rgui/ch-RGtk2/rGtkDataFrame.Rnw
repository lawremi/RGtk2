...
\begin{figure}
  ...
  \caption{A view of a data frame. This example uses
    ...
    shows how a checkbox cell render can be used for editing logical
...
display text, checkboxes, comboboxes and icons.  The cell render
...
%% logical toggle
For logical values, a checkbox is good way for the user to make
