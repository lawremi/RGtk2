...
\Shorttitle{\pkg{RGtk2}: A GUI Toolkit for \proglang{R}}
...
\subsubsection[GType]{\code{GType}}
...
\subsubsection[GSignal]{\code{GSignal}}
...
a
switch. A second \proglang{XML}-based format, \proglang{GIR}
\citep{gobject-introspection}, has
recently been developed as a unifying standard for representing
\pkg{GObject}-based API's.  The use of
