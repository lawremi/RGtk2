...
df <- rbind(
            c("TkDefaultFont","The default for all GUI items not otherwise specified."),
            c("TkTextFont","Font for text widgets"),
            c("TkFixedFont","Fixed-width font."),
            c("TkMenuFont","Menu bar fonts"),
            c("TkHeadingFont","Font for column headings"),
            c("TkCaptionFont","Caption font (dialogs)"),
            c("TkSmallCaptionFont","Smaller caption font"),
            c("TkIconFont","Icon and text font")
            )
cat(booktabs(df, 
...
<<ReturnValueDoesNotStopPropogation, echo=FALSE>>=
