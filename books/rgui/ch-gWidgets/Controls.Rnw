...
df <- rbind(
            ...
            c("\\constructor{gcombobox}", "A drop-down list of values"),
            c("\\constructor{gtable}", "A table (vector or data frame) of values for selection"),
            c("\\constructor{gslider}", "A slider to select a value"),
            c("\\constructor{gspinbutton}", "A spinbutton to select from a set of values"),
            ...
            c("\\constructor{gmenubar}", "Puts a menubar on a top-level window "),
            ...
            c("\\constructor{gtooltip}", "Add tooltip to widget"),
...
colnames(df) <- c("Attr","Possible value")
cat(booktabs(df, 
