...
df <- rbind(
            c("html","Denotes an HTML file"),
            c("head","Marks header of file"),
            c("body","Marks off main body of file"),
            c("script","Used to include other types of files"),
            c("p","A paragraph. Also, br for a line break"),
            c("h1","First level header. Also h2,...,h6"),
            c("ul", "Unordered list. Also ol."),
            c("li", "Denotes a list item"),
            c("a", "An anchor for a hyperreference"),
            c("img", "Denotes an image"),
            c("div","A text division, indicates a line break"),
            c("span","A text division, no implied break"),
            c("b","Denotes text to be set in bold"),
            c("code","Denotes text that is code"),
            c("em","Denotes text to be emphasized"),
            c("table","Creates a table element")
            )
