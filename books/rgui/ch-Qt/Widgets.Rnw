...
<<qt-widget-button-connect, result=hide>>=
...
%% JV: needs to upgrade
<<qt-widget-lineedit-placeholder,eval=FALSE>>=
le$text <- ""
...
%% JV: I don't see this in the git sources. Am I missing something?
<<qt-widget-graphics-device-opengl, eval=FALSE>>=
