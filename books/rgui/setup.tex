...
\newcommand{\defn}[1]{\textit{#1}\index{#1|textbf}}   % add in index
...
\newcommand{\argument}[2]{\args{#1}\index{#2!\texttt{#1}}} % name of
                                % an argument, plus
...
\newcommand{\method}[2]{\meth{#1}\index{#2!\texttt{#1}}} % name of method with
                                % class for index
...
\newcommand{\qtenumeration}[1]{\generic{#1}\index{Qt enumerations!\texttt{#1}}} % an enumerated flag in
\newcommand{\enumeration}[1]{\qtenumeration{#1}}
%% Gtk enumeration
\newcommand{\gtkenum}[1]{\generic{#1}\index{GTK enumerations!\texttt{#1}}}
                                % Qt$Qt object
...
\newcommand{\pkg}[1]{\texttt{#1}\index{R Package!\code{#1}}}
