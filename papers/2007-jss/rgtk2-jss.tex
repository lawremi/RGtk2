...
\begin{figure}
\begin{center}
\includegraphics[width=3in]{class-hierarchy.png}
...
exact series of \pkg{GTK+} to install, as \pkg{RGtk2} is source compatible with 
...
as \emph{GtkComboBox} in \pkg{GTK+}, may be appropriate. The following snippet 
