...
the \property{title} property, may be aligned to left, right or
center, depending on the \property{alignment} property, see
Figure~\ref{fig:group-box-example}. If the \property{checkable}
