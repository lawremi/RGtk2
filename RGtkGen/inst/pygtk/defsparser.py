...
class DefsParser(IncludeParser):
	...
	self.user_functions = [] # user functions
    ...
    def define_user_function(self, *args):
	ufdef = apply(FunctionDef, args)
	self.user_functions.append(ufdef)
	self.c_name[ufdef.c_name] = ufdef
