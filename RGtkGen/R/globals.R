...
badCFuncs <- c("gtk_editable_insert_text", "gtk_clipboard_set_with_owner", "gtk_item_factory_create_item", 
    ...
    "pango_font_descriptions_free", "pango_context_new", "gdk_rgb_find_color",
    ...
    "gdk_pixbuf_get_pixels", "gtk_menu_get_for_attach_widget", "gdk_draw_rgb_image",
	"gtk_list_store_set_value", "gtk_tree_path_get_indices", "gdk_pixbuf_save_to_bufferv",
...
"pango_layout_iter_free", "pango_tab_array_free")
...
"gdk-pixbuf-xlib-rendering", "inline", "refcounting", "cairo-ft", "cairo-glitz", "cairo-pdf", "cairo-ps",
