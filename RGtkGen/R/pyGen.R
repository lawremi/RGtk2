...
# Originally written by Duncan Lang, heavily modified by Michael Lawrence
...
function(fileName = "gtk.defs")
{
 ...
 # converts the raw python parser object to an R data structure for code generation
 # includes GType Id's... not sure if this is necessary since it can be obtained at runtime
