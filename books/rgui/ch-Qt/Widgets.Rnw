...
sapply(button_group$buttons(), function(button) button$checked <- TRUE)
@ 
%
...
if(any(checked)) {
  ...
  message(sprintf("You've selected %d cases", sum(checked_cylinders)))
}
@ 
%
...
radio_buttons <- list(Qt$QRadioButton("Weight < 3000", w),
