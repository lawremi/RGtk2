...
a menu bar, toolbar, a large application-specific region, and a
...
<<rgtk2-menus-action-appearance, eval=FALSE>>=
...
%% JV XXX THis causes my R to crash XXX
...
<<rgtk2-menus-tool-palette-collapse>>=
