...
display through an \R\/ graphics device. The \Rfunction{layoutBoard}
...
the controls. GUI's often have shortucts that allow power users to
...
A \dfn{button} issues commands when pressed, usually via a mouse click.
