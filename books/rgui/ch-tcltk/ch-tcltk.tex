...
various widgets. This use of the flyweight design pattern allows
memory resources to be shared as much as possible.

Images are created by the \function{tkimage.create}
function. 
...
\begin{Sinput}
 makeMonth <- function(w, year, month) {
   ...
   ## add days
   sapply(seq_len(ProgGUIinR:::days.in.month(year, month)),  function(day) {
     l <- ttklabel(w, text=day)
     tkgrid(l, row=1 + ProgGUIinR:::week.of.month(year, month, day),
            column=ProgGUIinR:::day.of.week(year, month, day),
            sticky="e")
   })
 }
\end{Sinput}
...
1st row and first character, although \code{0.0} will do the
...
\argument{height}{tkcanvas}, and \argument{background}{tkcanvas},
