...
\emph{GtkTreeView}
widget. \pkg{GTK+} treats lists as a table with a single column, and
the rows in
a table can have a tree structure, which explains the name of the
widget.
In this case, of course, we want the rows to be flat. \pkg{RGtk2}
provides a 
...
is displayed in a table, using a \emp{GtkTreeView} widget. As we would
