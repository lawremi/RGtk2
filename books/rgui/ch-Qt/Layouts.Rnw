...
the size hint depends on the \property{sizePolicy}{QWidget} property. The size
...
values are flags andmay be combined with \code{\|} to specify both vertical and
...
center, depending on the \property{alignment}{QGroupBox} property, see
Figure~\ref{fig:group-box-example}. If the \property{checkable}{QGroupBox}
