...
list. Populating the \constructor{gtree} widget is done by dynamically computing the
child components. A parameterizion of the data to be displayed in terms
of the path of the node that is currently selected is used. 
...
explore the hierarchical structure of a list. It uses a closure to
...
\constructor{gaction} constructor. The arguments are
...
page server) this widget provides a light-weight alternative.
